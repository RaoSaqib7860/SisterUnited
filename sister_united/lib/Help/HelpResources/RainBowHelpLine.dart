...
class RainBowHelpLine extends StatefulWidget {
  RainBowHelpLine({Key key}) : super(key: key);

  @override
  _RainBowHelpLineState createState() => _RainBowHelpLineState();
}

class _RainBowHelpLineState extends State<RainBowHelpLine> {
