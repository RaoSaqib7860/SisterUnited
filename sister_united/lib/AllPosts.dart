...
import 'Providers/AllProviders/AllPostProvider.dart';

class AllPosts extends StatefulWidget {
  final String subCatId;
  AllPosts({Key key, this.subCatId}) : super(key: key);
...
class _AllPostsState extends State<AllPosts> {
  ...
  @override
  void initState() {
    final _provider = Provider.of<AllPostProvider>(context, listen: false);
    getApiData(_provider);
    super.initState();
  }

  getApiData(AllPostProvider provider) {
    AllApiUtils.apigetAllPost(provider: provider, id: widget.subCatId);
  }
  ...
  Widget build(BuildContext context) {
    ...
    var width = Get.width;
    final _provider = Provider.of<AllPostProvider>(context);
    return SafeArea(
      child: Scaffold(
        key: scaffoldkey,
        drawer: Drawer(
                  ...
                  children: [
                    ...
                    Expanded(
                        child: _provider.loading == false
                            ...
                            : _provider.listOfAllPost.isEmpty
                                ? Center(
                                    child: Text('Empty'),
                                  )
                                : ListView.builder(
                                            ...
                                            children: [
                                              ...
                                              ListTile(
                                                ...
                                                title: Column(
                                                  ...
                                                  children: [
                                                    Text(
                                                      '${_provider.listOfAllPost[i]['title']}',
                                                      style: TextStyle(
                                                          fontSize: 14),
                                                    ),
                                                    Text(
                                    ...
                                    itemCount: _provider.listOfAllPost.length,
                                  )),
                    SizedBox(
                      height: height / 10,
                    ),
